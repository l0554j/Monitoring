...
public class MainActivityBlutooth extends BaseActivity  {
	protected static final String TAG = MainActivityBlutooth.class.getSimpleName();
	...
	private TextView collect_blutooth,collect_wifi;
...
//			if((System.currentTimeMillis() - fisrtTime)>3*24*60*60*1000){
...
//			sendMessage(Command.makeWriteOrderSet(HexString2Bytes(orderTime)[0], HexString2Bytes(orderTime)[1]));
			sendMessageBuffer(Command.makeWriteOrderSet(HexString2Bytes(hour+minute)[0], HexString2Bytes(hour+minute)[1]));
			break;
...
//			showToast("产品生产日期");
			...
			break;
		case R.id.collect_wifi:
//			startActivityForResult(new Intent(
//					android.provider.Settings.ACTION_WIFI_SETTINGS), 0);
			startActivity(new Intent(android.provider.Settings.ACTION_WIFI_SETTINGS));
			break;
		case R.id.collect_blutooth:
